...
GRANT SELECT, INSERT ON collections TO tides;
GRANT SELECT, UPDATE ON collections_id_seq TO tides;
GRANT SELECT, INSERT, DELETE ON g_l_strings TO tides;
GRANT SELECT, UPDATE ON g_l_strings_id_seq TO tides;
GRANT SELECT, INSERT, DELETE ON gfes TO tides;
GRANT SELECT, UPDATE ON gfes_id_seq TO tides;
GRANT SELECT, INSERT ON properties TO tides;
GRANT SELECT, UPDATE ON properties_id_seq TO tides;
GRANT SELECT, INSERT ON fixed_values TO tides;
GRANT SELECT, UPDATE ON fixed_values_id_seq TO tides;
GRANT SELECT, INSERT, DELETE ON samples TO tides;
GRANT SELECT, UPDATE ON samples_id_seq TO tides;
GRANT SELECT, INSERT ON sample_text_properties TO tides;
GRANT SELECT, INSERT ON sample_fixed_properties TO tides;
GRANT SELECT, INSERT ON sample_numeric_properties TO tides;
GRANT SELECT, INSERT ON sample_date_properties TO tides;
GRANT SELECT, INSERT, UPDATE, DELETE ON sessions TO tides;
GRANT SELECT, INSERT, DELETE ON uploads TO tides;
GRANT SELECT, UPDATE ON uploads_id_seq TO tides;
GRANT SELECT, INSERT ON users TO tides;
GRANT SELECT, UPDATE ON users_id_seq TO tides;
GRANT SELECT ON v_plink TO tides;
GRANT SELECT ON v_uploads TO tides;
